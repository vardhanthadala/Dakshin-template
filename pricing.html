    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                ...
                <div class="td-breadcrumb-area td-breadcrumb-spacing mb-85">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="td-breadcrumb-wrap">
                                    <span class="subtitle d-inline-block mb-15  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">OUR PRICING PLANS</span>
                                    <h2 class="td-section-page-title mb-35  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">Our suitable pricing<br> 
                                        plans <span>for you</span></h2>
                                    <p class="text  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse  varius
                ...
                <div class="td-pricing-area td-pricing-main-wrap pb-130">
                    <div class="container">
                        <div class="row">
                ...
                <!-- td-faq-2-area-start -->
                <div class="td-faq-2-area pb-130">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
