                            ...
                            <nav class="tdmenu__nav">
                                <div class="tdmenu__navbar-wrap tdmenu__main-menu">
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="portfolio-two-columns.html">Portfolio</a>
                                            <ul class="sub-menu">
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                ...
                <div class="td-breadcrumb-area td-breadcrumb-spacing mb-55">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <div class="td-breadcrumb-wrap text-center">
                                    <span class="subtitle d-inline-block mb-15  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">BRAND IDENTITY AND WEB DEVELOPMENT</span>
                                    <h2 class="td-section-page-title mb-85  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">Unique visual identity to
                                        bring <span> in digital agency</span></h2>
                                </div>
                                <div class="td-portfolio-details-info  wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                    <div class="td-portfolio-details-info-item mb-20">
                                        <h5 class="titles">Published</h5>
                                        <span class="dates">11 December 2023</span>
                                    </div>
                                    <div class="td-portfolio-details-info-item mb-20">
                                        <h5 class="titles">Country</h5>
                                        <span class="dates"> United kingdom</span>
                                    </div>
                                    <div class="td-portfolio-details-info-item mb-20">
                                        <h5 class="titles">Industry</h5>
                                        <span class="dates">Web Development</span>
                                    </div>
                                    <div class="td-portfolio-details-info-item mb-20">
                                        <h5 class="titles">Website</h5>
                                        <span class="dates">parodydesign.com</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- td-portfolio-thumb-area -->
                <div class="td-portfolio-area">
                    <img src="assets/img/portfolio/details/thumb.jpg" alt="">
                </div>
                <!-- td-portfolio-thumb-end -->

                <!-- td-portfolio-brand-view-start -->
                <div class="td-portfolio-brand-view pt-150 pb-90">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-8 col-lg-7">
                                <div class="td-portfolio-brand-title-wrap mb-30">
                                    <h2 class="td-section-page-title">Brand <span>overview</span></h2>
                                    <div class="td-portfolio-brand-dates pt-155 mb-140">
                                        <img class="mb-15" src="assets/img/portfolio/details/text.png" alt="">
                                        <p><span>Awards - </span> site of the day 2020</p>
                                    </div>
                                    <h2 class="td-portfolio-brand-bigtext mb-0">Parody agency </h2>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-5">
                                <div class="td-portfolio-brand-content mb-30">
                                    <p class="mb-65">We are excited for our work and how it positively impacts
                                    ...
                                    <div class="td-portfolio-brand-list pb-125">
                                        <h5 class="td-portfolio-brand-list-title">Branding and identity</h5>
                                        <div class="td-portfolio-brand-list-border mt-20 mb-20"></div>
                                        <h5 class="td-portfolio-brand-list-title">Websites and digital platforms</h5>
                                        <div class="td-portfolio-brand-list-border mt-20 mb-20"></div>
                                        <h5 class="td-portfolio-brand-list-title">Content strategy for social media</h5>
                                        <div class="td-portfolio-brand-list-border mt-20"></div>
                                    </div>
                                    <h5 class="td-portfolio-brand-list-title mb-20">About development agency</h5>
                ...
                <!-- td-portfolio-brand-view-end -->

                <!-- td-portfolio-thumb-area -->
                <div class="td-portfolio-area">
                    <div class="container-fluid container-1530">
                        <div class="row">
                            <div class="col-12">
                                <div class="td-portfolio-details-thumb">
                                    <img class="w-100" src="assets/img/portfolio/details/thumb-2.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- td-portfolio-visual-identity-area-start -->
                 <div class="td-portfolio-identity-area pt-120 pb-160">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="td-portfolio-identity-title mb-85">
                                    <h2 class="td-section-page-title">Visual Identity</h2>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <span class="td-portfolio-identity-subtitle">An introduction</span>
                            </div>
                            <div class="col-xl-6 col-lg-8">
                                <div class="td-portfolio-identity-content pb-105">
                                    <h5 class="mb-30">Creative agencies are known for their ability to think outside the box, offering fresh, innovative solutions to clients' marketing and branding needs. Many creative agencies focus on specific industries.</h5>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-11">
                                <div class="td-portfolio-identity-slider-wrap">
                                    <div class="swiper-container td-portfolio-identity-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="td-portfolio-identity-slider-thumb">
                                                    <img class="w-100" src="assets/img/portfolio/details/thumb-3.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="td-portfolio-identity-slider-thumb">
                                                    <img class="w-100" src="assets/img/portfolio/details/thumb-4.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="td-portfolio-identity-slider-thumb">
                            ...
                            <div class="col-lg-4">
                                <div class="td-portfolio-identity-navigation d-flex justify-content-between pt-80 align-items-center">
                                    <span class="td-portfolio-identity-prev">
                                        <i class="fa-solid fa-arrow-left"></i>
                                        Prev
                                    </span>
                                    <div class="td-portfolio-identity-border"></div>
                                    <span class="td-portfolio-identity-next">
                                        Next
                ...
                <!-- td-portfolio-visual-identity-area-end -->
