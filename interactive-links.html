...
<body data-background="assets/img/intarective-links/bg.jpg">
    ...
    <!-- header-area -->
    <header>
        <div id="header-sticky" class="td-header__area td-header-sticky-white td-header-5-wrapper td-header-7-wrapper td-header-showcase p-relative z-index-1">
                                    ...
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="index.html">Home</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="interactive-links.html">Interactive links</a></li>
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <main>
                <div class="td-interactive-links-spacing">
                    <div class="container-fluid container-1550">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="td-interactive-links-wrap">
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>01</span>SQUARDO</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>02</span>LOUP</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>03</span>KROUPS</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>04</span>FIRSTWIRE</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>05</span>COSMETICS</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>06</span>OKIOS</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active mr-80">
                                        <h2 class="title"><a href="portfolio-details.html"><span>07</span>TOURISM</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                    <div class="td-interactive-links-item p-relative d-inline-block td-thumb-hover-item active">
                                        <h2 class="title"><a href="portfolio-details.html"><span>08</span>SKILVISON</a></h2>
                                        <div class="td-interactive-links-thumb" data-background="assets/img/intarective-links/thumb.png"></div>
                                    </div>
                                </div>
                            </div>
