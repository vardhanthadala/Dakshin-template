                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="td-breadcrumb-wrap">
                                    <span class="subtitle d-inline-block mb-15  wow fadeInUp" data-wow-delay=".4s" data-wow-duration="1s">OUR TEAM MEMBERS</span>
                                    <h2 class="td-section-page-title mb-35  wow fadeInUp" data-wow-delay=".6s" data-wow-duration="1s">Our Talented <br> <span>Team Members</span></h2>
                                    <p class="text  wow fadeInUp" data-wow-delay=".8s" data-wow-duration="1s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse  varius
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="td-team-4-wrap p-relative mb-30">
                                    <div class="td-team-4-thumb">
                                        <img class="w-100" src="assets/img/team/thumb-5.jpg" alt="">
                                    </div>
                                    <div class="td-team-4-content text-center">
                                        <span class="td-team-4-subtitle">Developer</span>
                                        <h3 class="td-team-4-title"><a href="team-details.html">PITTERSON</a></h3>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div class="td-team-4-wrap p-relative mb-30">
                                    <div class="td-team-4-thumb">
                                        <img class="w-100" src="assets/img/team/thumb-6.jpg" alt="">
                                    </div>
                                    <div class="td-team-4-content text-center">
                                        <span class="td-team-4-subtitle">Developer</span>
                                        <h3 class="td-team-4-title"><a href="team-details.html">JOTIN</a></h3>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div class="td-team-4-wrap p-relative mb-30">
                                    <div class="td-team-4-thumb">
                                        <img class="w-100" src="assets/img/team/thumb-7.jpg" alt="">
                                    </div>
                                    <div class="td-team-4-content text-center">
                                        <span class="td-team-4-subtitle">Developer</span>
                                        <h3 class="td-team-4-title"><a href="team-details.html">DANDU</a></h3>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                <div class="td-team-4-wrap p-relative mb-30">
                                    <div class="td-team-4-thumb">
                                        <img class="w-100" src="assets/img/team/thumb-8.jpg" alt="">
                                    </div>
                                    <div class="td-team-4-content text-center">
                                        <span class="td-team-4-subtitle">Developer</span>
                                        <h3 class="td-team-4-title"><a href="team-details.html">SAMIR</a></h3>
