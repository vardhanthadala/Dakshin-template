    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="td-breadcrumb-wrap">
                                    <span class="subtitle d-inline-block mb-15  wow fadeInLeft" data-wow-delay=".4s" data-wow-duration="1s">TEAM MEMBERS</span>
                                    <h2 class="td-section-page-title mb-35  wow fadeInLeft" data-wow-delay=".6s" data-wow-duration="1s">Our Talented <br> <span>Team Members</span></h2>
                                    <p class="text  wow fadeInLeft" data-wow-delay=".8s" data-wow-duration="1s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse  varius
                ...
                <div class="td-team-details-area">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="td-team-details-thumb mb-40  wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1s">
                                    <img src="assets/img/team/details/thumb.png" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="td-team-details-content mt-60 mb-40  wow fadeInRight" data-wow-delay=".5s" data-wow-duration="1s">
                                    <span class="td-team-details-subtitle mb-10">I am a professional designer</span>
                                    <h2 class="td-team-details-title mb-20">Brandon Hussy</h2>
                                    <p class="mb-20">On the other hands, we denounce with righteous indignation dislikes men who are so beguiled and demoralized by the charms of pleasure of the moment so blinded by desire that they cannot foresee the pain and trouble that are bound to ensue.
                                    ...
                                    <div class="td-team-details-tag-list mb-35">
                                        <h5 class="td-team-details-tag-title mb-15">Portfolio:</h5>
                                        <ul>
                                    ...
                                    <div class="td-team-details-social td-footer-social">
                                        <h5 class="td-team-details-tag-title mb-15">Follow:</h5>
                                        <a href="#">
                ...
                <!-- td-brand-area-start -->
                <div class="td-brand-area  pt-90 pb-150">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
