        ...
        <div id="smooth-content">
            <main>
                ...
                <div class="td-breadcrumb-2-spacing">
                    <div class="td-shop-breadcrumb-area td-shop-breadcrumb-spacing include-bg" data-background="assets/img/breadcrumb/bg.jpg">
                        <div class="container-fluid container-1710">
                            <div class="row">
                                <div class="col-12">
                                    <div class="td-shop-breadcrumb-wrap text-center">
                                        <h2 class="td-shop-breadcrumb-title mb-30  wow fadeInUp" data-wow-delay=".4s" data-wow-duration="1s">Smart shopping with Parody</h2>
                                        <div class="td-shop-breadcrumb-dvdr  wow fadeInUp" data-wow-delay=".6s" data-wow-duration="1s">
                ...
                <!-- td-shop-area-start -->
                <div class="td-shop-area pt-155 pb-110">
                    <div class="container-fluid container-1710">
                        <div class="row">
                            <div class="col-xxl-2 col-xl-3 col-lg-4">
                                <div class="td-shop-sidebar">
                                    <!-- status -->
                                    <div class="td-shop-widget mb-35">
                                        <h3 class="td-shop-widget-title mb-20">Price Filter</h3>
                                        <div class="td-shop-widget-content">
                                            <div class="td-shop-widget-filter">
                                                <div id="slider-range" class="mb-10"></div>
                                                <div class="td-shop-widget-filter-info d-flex align-items-center justify-content-between">
                                                    <span class="input-range">
                                                        <input type="text" id="amount" readonly>
                                                    </span>
                                                    <button class="td-shop-widget-filter-btn" type="button">Reset</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- status -->
                                    <div class="td-shop-widget mb-35">
                                        <h3 class="td-shop-widget-title mb-20">Product Status</h3>
                                        <div class="td-shop-widget-content">
                                            <div class="td-shop-widget-checkbox">
                                    ...
                                    <!-- categories -->
                                    <div class="td-shop-widget mb-35">
                                        <h3 class="td-shop-widget-title mb-20">Categories</h3>
                                        <div class="td-shop-widget-content">
                                        <div class="td-shop-widget-categories">
                                            <ul>
                                                <li><a href="#">Cloathing<span>10</span></a></li>
                                                <li><a href="#">Classic chair<span>18</span></a></li>
                                                <li><a href="#">Hoodies<span>22</span></a></li>
                                                <li><a href="#">Tshirts<span>17</span></a></li>
                                                <li><a href="#">Decor<span>22</span></a></li>
                                                <li><a href="#">Lifestyle<span>14</span></a></li>
                                                <li><a href="#">Music<span>19</span></a></li>
                                                <li><a href="#">Rider pack<span>29</span></a></li>
                                                <li><a href="#">Uncategorized <span>05</span></a></li>
                                            </ul>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="td-shop-widget mb-40">
                                        <h3 class="td-shop-widget-title mb-20">Filter by Color</h3>
                                        <div class="td-shop-widget-content">
                                           <div class="td-shop-widget-checkbox-circle-list">
                                              <ul>
                                                 <li>
                                                    <div class="td-shop-widget-checkbox-circle">
                                                       <input type="checkbox" id="red">
                                                       <label for="red">Red</label>
                                                       <span class="td-shop-widget-checkbox-circle-self red"></span>
                                                    </div>
                                                    <span class="td-shop-widget-checkbox-circle-number">8</span>
                                                 </li>
                                                 <li>
                                                    <div class="td-shop-widget-checkbox-circle">
                                                       <input type="checkbox" id="dark_blue">
                                                       <label for="dark_blue">Dark Blue</label>
                                                       <span class="td-shop-widget-checkbox-circle-self dark_blue"></span>
                                                    </div>
                                                    <span class="td-shop-widget-checkbox-circle-number">14</span>
                                                 </li>
                                                 <li>
                                                    <div class="td-shop-widget-checkbox-circle">
                                                       <input type="checkbox" id="oragnge">
                                                       <label for="oragnge">Orange</label>
                                                       <span class="td-shop-widget-checkbox-circle-self oragnge"></span>
                                                    </div>
                                                    <span class="td-shop-widget-checkbox-circle-number">18</span>
                                                 </li>
                                                 <li>
                                                    <div class="td-shop-widget-checkbox-circle">
                                                       <input type="checkbox" id="purple">
                                                       <label for="purple">Purple</label>
                                                       <span class="td-shop-widget-checkbox-circle-self purple"></span>
                                                    </div>
                                                    <span class="td-shop-widget-checkbox-circle-number">23</span>
                                                 </li>
                                                 <li>
                                                    <div class="td-shop-widget-checkbox-circle">
                                                       <input type="checkbox" id="yellow">
                                                       <label for="yellow">Yellow</label>
                                                       <span class="td-shop-widget-checkbox-circle-self yellow"></span>
                                                    </div>
                                                    <span class="td-shop-widget-checkbox-circle-number">17</span>
                                                 </li>
                                                 <li>
                                                    <div class="td-shop-widget-checkbox-circle">
                                                       <input type="checkbox" id="green">
                                                       <label for="green">Green</label>
                                                       <span class="td-shop-widget-checkbox-circle-self green"></span>
                                                    </div>
                                                    <span class="td-shop-widget-checkbox-circle-number">15</span>
                                                 </li>
                                              </ul>
                                           </div>
                                        </div>
                                    </div>
                                    <div class="td-shop-widget mb-45">
                                        <h3 class="td-shop-widget-title mb-20">Top Rated Products</h3>
                                        <div class="td-shop-small-product d-flex align-items-center mb-20">
                                            <div class="td-shop-small-thumb">
                                                <img src="assets/img/shop/small/thumb-2.jpg" alt="">
                                            </div>
                                            <div class="td-shop-small-content">
                                                <div class="td-shop-small-ratings">
                                                    <span class="ratings">
                                                ...
                                                <h5 class="td-shop-small-title"><a href="shop-details.html">Trendy smart phone</a></h5>
                                                <span class="td-shop-small-price">$65.00</span>
                                            </div>
                                        </div>
                                        <div class="td-shop-small-product d-flex align-items-center mb-20">
                                            <div class="td-shop-small-thumb">
                                                <img src="assets/img/shop/small/thumb.png" alt="">
                                            </div>
                                            <div class="td-shop-small-content">
                                                <div class="td-shop-small-ratings">
                                                    <span class="ratings">
                                                ...
                                                <h5 class="td-shop-small-title"><a href="shop-details.html">Digital fishtrax metal</a></h5>
                                                <span class="td-shop-small-price">$65.00</span>
                                            </div>
                                        </div>
                                        <div class="td-shop-small-product d-flex align-items-center mb-20">
                                            <div class="td-shop-small-thumb">
                                                <img src="assets/img/shop/small/thumb-3.png" alt="">
                                            </div>
                                            <div class="td-shop-small-content">
                                                <div class="td-shop-small-ratings">
                                                    <span class="ratings">
                                                ...
                                                <h5 class="td-shop-small-title"><a href="shop-details.html">Trending watch man</a></h5>
                                                <span class="td-shop-small-price">$625.00</span>
                                            </div>
                                        </div>
                                        <div class="td-shop-small-product d-flex align-items-center mb-20">
                                            <div class="td-shop-small-thumb">
                                                <img src="assets/img/shop/small/thumb-4.jpg" alt="">
                                            </div>
                                            <div class="td-shop-small-content">
                                                <div class="td-shop-small-ratings">
                                                    <span class="ratings">
                                                ...
                                                <h5 class="td-shop-small-title"><a href="shop-details.html">Digital fishtrax metal</a></h5>
                                                <span class="td-shop-small-price">$165.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="td-shop-widget mb-40">
                                        <h3 class="td-shop-widget-title mb-25">Social Media</h3>
                                        <div class="td-footer-social td-shop-small-social">
                                            <a href="#">
                            ...
                            <div class="col-xxl-10 col-xl-9 col-lg-8">
                                <div class="td-shop-sidebar-wrap mb-50">
                                    <div class="td-shop-top mb-45">
                                        <div class="row align-items-center">
                                            <div class="col-xl-6 col-lg-5 col-md-5">
                                                <div class="td-shop-top-left">
                                                    <div class="td-shop-top-result mb-10">
                                                        <p>Showing 1–14 of 26 results</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-7 col-md-7">
                                                <div class="td-shop-top-right d-flex justify-content-start align-items-center justify-content-md-end">
                                                    <div class="td-shop-top-select">
                                                        <select class="select">
                                                    ...
                                                    <button class="td-shop-top-btn ml-15">
                                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M15.0008 3.44995H10.8008" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M3.8 3.44995H1" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M6.59844 5.9C7.95153 5.9 9.04844 4.8031 9.04844 3.45C9.04844 2.0969 7.95153 1 6.59844 1C5.24534 1 4.14844 2.0969 4.14844 3.45C4.14844 4.8031 5.24534 5.9 6.59844 5.9Z" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M14.9992 11.15H12.1992" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M5.2 11.15H1" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M9.39922 13.6C10.7523 13.6 11.8492 12.503 11.8492 11.15C11.8492 9.79685 10.7523 8.69995 9.39922 8.69995C8.04612 8.69995 6.94922 9.79685 6.94922 11.15C6.94922 12.503 8.04612 13.6 9.39922 13.6Z" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                        Filter
                                                    </button>
                                                </div>
                                    ...
                                    <div class="td-shop-main-wrap">
                                        <div class="row">
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/01.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                        </div>
                                                       <!-- product action -->
                                                       <div class="td-product-action">
                                                          <div class="td-product-action-item">
                                                             <button type="button" class="td-product-action-btn td-product-add-cart-btn">
                                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                   ...
                                                                   <span class="td-product-tooltip">Add to Cart</span>
                                                             </button>
                                                             <button type="button" class="td-product-action-btn td-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                                                <svg width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                   ...
                                                                   <span class="td-product-tooltip">Quick View</span>
                                                             </button>
                                                             <button type="button" class="td-product-action-btn td-product-add-to-wishlist-btn">
                                                                ...
                                                                <span class="td-product-tooltip">Add To Wishlist</span>
                                                             </button>
                                                          </div>
                                                       </div>
                                                    </div>
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Bamboo Basket</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$63.99</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/02.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Rocking Chair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$520.99</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/03.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Wishbone Chair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$123.99</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/04.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Chesterfield Chair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$160.00</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/05.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Adirondack Chair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$450.29</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/06.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Armchair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$63.99</span>
                                                       </div>
                                            ...
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/07.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Table Lamer</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$148.99</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/08.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Hanging Chair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$780.29</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 mb-40">
                                                <div class="td-product-item">
                                                    <div class="td-product-thumb mb-10 fix p-relative">
                                                        <div class="p-relative">
                                                            <a href="shop-details.html">
                                                               <img class="w-100" src="assets/img/shop/09.jpg" alt="product">
                                                            </a>
                                                            <div class="td-product-btn">
                                                                <a href="shop-details.html">SHOP NOW</a>
                                                            </div>
                                                    ...
                                                    <div class="td-product-content d-flex justify-content-between align-items-center">
                                                       <div class="td-product-category-wrap">
                                                          <span class="td-product-category">furniture</span>
                                                          <h5  class="td-product-title"><a href="shop-details.html">Office Chair</a></h5>
                                                       </div>
                                                       <div class="td-product-price-wrap">
                                                          <span class="td-product-price">$968.99</span>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="td-blog-pagenation justify-content-center d-flex mt-45">
                                                    <ul>
                                                       <li>
                                                          <a class="active" href="shop-sidebar.html">1</a>
                                                       </li>
                                                       <li>
                                                          <a href="shop-sidebar.html">2</a>
                                                       </li>
                                                       <li>
                                                          <a href="shop-sidebar.html">3</a>
                                                       </li>
                                                       <li>
                                                          <a href="shop-sidebar.html"><i class="fa-sharp fa-solid fa-arrow-right"></i></a>
                                                       </li>
                                                    </ul>
                                                 </div>
                                            </div>
