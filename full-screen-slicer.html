...
<body>
        ...
        <div id="header-sticky" class="td-header__area  td-header-5-wrapper td-header-7-wrapper td-header-showcase p-relative z-index-1">
            <div class="container-fluid container-1750">
                <div class="row align-items-center">
                    <div class="col-6">
                        <div class="logo">
                            <a class="logo-1" href="index.html"><img data-width="96" src="assets/img/logo/logo-ico-black.png" alt="Logo"></a>
                        </div>
                    </div>
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <!-- main-area -->
            <main>
                <div class="td-portfolio-slicer-area p-relative">
                    <div class="td-portfolio-slicer-area-inner">
                        <div id="app" class="td-portfolio-slicer-slider">
                            <!-- Slicer slider -->
                            <div class="swiper td-portfolio-slicer-active">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide has_fade_anim" data-fade-from="left">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-2.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-3.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-4.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-5.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-6.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-7.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <img class="swiper-slicer-image" src="assets/img/full-slider/thumb-8.jpg" alt="">
                                        <div class="slide-content">
                                            <div class="container">
                                                <h2 class="td-portfolio-slicer-title"><a href="portfolio-details.html">RUSTIC <span>WODERS</span></a></h2>
                                            </div>
                            ...
                            <div class="slider-nav-box overflow-hidden">
                                <div class="container-fluid container-1750">
                                    <div class="slider-nav">
                                        <div class="td-portfolio-slicer-button-prev nav-icon has_fade_anim" data-fade-from="left" data-on-scroll="0"
                                            data-delay="0.30">
                                            <i class="fa-solid fa-angle-left"></i>
                                        </div>
                                        <div class="td-portfolio-slicer-button-next nav-icon has_fade_anim" data-fade-from="right"
                    ...
                    <span class="td-portfolio-slicer-click">CLICK OR DRAG</span>
                </div>
            </main>
            <!-- main-area-end -->
        </div>
